...
public class WholeFragment extends BaseFragment {
    @Bind(R.id.lv_orders_whole)
    ListView lv_orders_whole;
        ...
        public void onSuccess(final Orders orders) {
            if(orders!=null){
                ...
                if(orders.getData()!=null&&orders.getData().size()>0){
                    ...
                    myOrdersListViewAdapter = new MyOrdersListViewAdapter(mContext, ordersDatas);
                    lv_orders_whole.setAdapter(myOrdersListViewAdapter);
