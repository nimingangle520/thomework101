...
public class WheelView extends View {
	...
	private void initResourcesIfNecessary() {
		if (itemsPaint == null) {
			...
			//Paint.FAKE_BOLD_TEXT_FLAG 文本仿粗体
	...
	private void drawValue(Canvas canvas) {
		valuePaint.setColor(getResources().getColor(R.color.colorFontSelect));
	...
	private void drawItems(Canvas canvas) {
		...
		itemsPaint.setColor(getResources().getColor(R.color.colorFont));
